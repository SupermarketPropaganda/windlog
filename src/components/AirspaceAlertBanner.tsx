...
export const AirspaceAlertBanner: React.FC<AirspaceAlertBannerProps> = ({
  navLog,
  ...
  return (
    <div className={`airspace-alert-banner ${bannerClass} ${isExpanded ? 'is-expanded' : ''}`}>
      <div className="airspace-banner-summary" onClick={toggleExpanded}>
